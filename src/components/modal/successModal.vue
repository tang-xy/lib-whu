    ...
    <div>
        ...
        <view class="modal-dialog" v-if="showModal" >
            <div class="modal-icon">
                <image src='https://system.lib.whu.edu.cn/mp-static/113/成功 (1)@2x.png' mode='aspectFit'/>
            </div>
            ...
            <view class="modal-footer">
                <view class="btn-confirm" @click=onConfirm data-status="confirm">{{buttontext}}</view>
            </view>
        </view>
